...
function loadPlayersPage(){
	...
	//document.getElementById('player_selector').innerHTML = '<a class="dropdown-item" href="#" onclick="switchPlayers(1)">butt</a>';
	//your_newly_created_element.setAttribute("onclick", "alert('blah');");
